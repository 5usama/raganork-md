...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~e0f57ce3942c8b7b88600184e9a4c90e:4b31354e354f41636774343d').trim() || '',
    ...
    ANTILINK_WARN: process.env.ANTILINK_WARN || '6',
    HEROKU: {
